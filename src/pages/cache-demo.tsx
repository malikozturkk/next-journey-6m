  ...
  return (
    <div className="min-h-screen bg-black text-white px-6 py-10">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <p className="flex gap-1 text-yellow-700">
          Network'de Disable cache kapalıysa, butona basınca 10 sn boyunca aynı
          veri gelir. Süre bitince veri yenilenir. Disable cache açıksa, her
          tıklamada farklı veri döner.
        </p>
        <button
          className="border rounded-xl p-2 bg-white text-black mt-4 cursor-pointer"
          onClick={fetchData}
        >
          Veriyi Getir
        </button>
